...
data class CalibrationData(
    ...
    fun getBuyOrdersRegion(): Rect = Rect(
        buyOrdersRegionLeft,
        buyOrdersRegionTop,
        buyOrdersRegionRight,
        buyOrdersRegionBottom
    )
    
    fun getPriceInputRegion(): Rect = Rect(
        priceInputRegionLeft,
        priceInputRegionTop,
        priceInputRegionRight,
        priceInputRegionBottom
    )
}
...
data class MarketOrder(
    ...
    val topMarketPrice: Int = 0,
    val isUserOrder: Boolean = false,
    val orderId: String = ""
)
